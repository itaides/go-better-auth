...
func newPendingCookieRequest(t *testing.T, path string, body any, pendingToken string) (*http.Request, *models.RequestContext, *httptest.ResponseRecorder) {
	...
	req.AddCookie(&http.Cookie{Name: "two_factor_pending", Value: pendingToken})
	return req, reqCtx, w
}
...
func TestEnableHandler_Success(t *testing.T) {
	...
	req, reqCtx, w := newAuthenticatedRequest(t, "POST", "/two-factor/enable", types.EnableRequest{Password: "pass"})
...
func TestEnableHandler_Unauthenticated(t *testing.T) {
	...
	req, reqCtx, w := newUnauthenticatedRequest(t, "POST", "/two-factor/enable", types.EnableRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestEnableHandler_InvalidBody(t *testing.T) {
	h := &EnableHandler{UseCase: &mockEnableUC{}}
	req := httptest.NewRequest("POST", "/two-factor/enable", bytes.NewReader([]byte("not-json")))
	w := httptest.NewRecorder()
	userID := "user-1"
	reqCtx := &models.RequestContext{
		Request:        req,
...
func TestDisableHandler_Success(t *testing.T) {
	...
	req, reqCtx, w := newAuthenticatedRequest(t, "POST", "/two-factor/disable", types.DisableRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestDisableHandler_Unauthenticated(t *testing.T) {
	...
	req, reqCtx, w := newUnauthenticatedRequest(t, "POST", "/two-factor/disable", types.DisableRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestGetTOTPURIHandler_Success(t *testing.T) {
	...
	req, reqCtx, w := newAuthenticatedRequest(t, "POST", "/two-factor/get-totp-uri", types.GetTOTPURIRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestGetTOTPURIHandler_Unauthenticated(t *testing.T) {
	...
	req, reqCtx, w := newUnauthenticatedRequest(t, "POST", "/two-factor/get-totp-uri", types.GetTOTPURIRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestGenerateBackupCodesHandler_Success(t *testing.T) {
	...
	req, reqCtx, w := newAuthenticatedRequest(t, "POST", "/two-factor/generate-backup-codes", types.GenerateBackupCodesRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestGenerateBackupCodesHandler_Unauthenticated(t *testing.T) {
	...
	req, reqCtx, w := newUnauthenticatedRequest(t, "POST", "/two-factor/generate-backup-codes", types.GenerateBackupCodesRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestViewBackupCodesHandler_Success(t *testing.T) {
	...
	req, reqCtx, w := newAuthenticatedRequest(t, "POST", "/two-factor/view-backup-codes", types.ViewBackupCodesRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestViewBackupCodesHandler_Unauthenticated(t *testing.T) {
	...
	req, reqCtx, w := newUnauthenticatedRequest(t, "POST", "/two-factor/view-backup-codes", types.ViewBackupCodesRequest{Password: "pass"})
	h.Handler().ServeHTTP(w, req)
...
func TestVerifyTOTPHandler_Success(t *testing.T) {
	...
	cfg := &types.TwoFactorPluginConfig{SameSite: "lax"}
	h := &VerifyTOTPHandler{UseCase: uc, PluginConfig: cfg}

	req, reqCtx, w := newPendingCookieRequest(t, "/two-factor/verify-totp", types.VerifyTOTPRequest{Code: "123456"}, "pending-abc")
	h.Handler().ServeHTTP(w, req)
...
func TestVerifyTOTPHandler_WithTrustedDevice(t *testing.T) {
	...
	cfg := &types.TwoFactorPluginConfig{
	...
	req, reqCtx, w := newPendingCookieRequest(t, "/two-factor/verify-totp", types.VerifyTOTPRequest{Code: "123456", TrustDevice: true}, "pending-abc")
	h.Handler().ServeHTTP(w, req)
...
func TestVerifyTOTPHandler_MissingPendingCookie(t *testing.T) {
	h := &VerifyTOTPHandler{UseCase: &mockVerifyTOTPUC{}, PluginConfig: &types.TwoFactorPluginConfig{}}

	req, reqCtx, w := newAuthenticatedRequest(t, "POST", "/two-factor/verify-totp", types.VerifyTOTPRequest{Code: "123456"})
...
func TestVerifyTOTPHandler_InvalidBody(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/two-factor/verify-totp", bytes.NewReader([]byte("bad")))
	req.AddCookie(&http.Cookie{Name: "two_factor_pending", Value: "token"})
	w := httptest.NewRecorder()
	reqCtx := &models.RequestContext{
		Request:        req,
		ResponseWriter: w,
...
func TestVerifyTOTPHandler_InvalidCode(t *testing.T) {
	...
	h := &VerifyTOTPHandler{UseCase: uc, PluginConfig: &types.TwoFactorPluginConfig{}}

	req, reqCtx, w := newPendingCookieRequest(t, "/two-factor/verify-totp", types.VerifyTOTPRequest{Code: "000000"}, "pending-abc")
	h.Handler().ServeHTTP(w, req)

	assert.Equal(t, http.StatusUnauthorized, reqCtx.ResponseStatus)
}

func TestVerifyTOTPHandler_TwoFactorNotEnabled(t *testing.T) {
	uc := &mockVerifyTOTPUC{fn: func(_ context.Context, _, _ string, _ bool, _, _ *string) (*types.VerifyResult, error) {
...
func TestVerifyBackupCodeHandler_Success(t *testing.T) {
	...
	req, reqCtx, w := newPendingCookieRequest(t, "/two-factor/verify-backup-code", types.VerifyBackupCodeRequest{Code: "abc123"}, "pending-abc")
	h.Handler().ServeHTTP(w, req)
...
func TestVerifyBackupCodeHandler_WithTrustedDevice(t *testing.T) {
	...
	req, reqCtx, w := newPendingCookieRequest(t, "/two-factor/verify-backup-code", types.VerifyBackupCodeRequest{Code: "abc123", TrustDevice: true}, "pending-abc")
	h.Handler().ServeHTTP(w, req)
...
func TestVerifyBackupCodeHandler_MissingPendingCookie(t *testing.T) {
	h := &VerifyBackupCodeHandler{UseCase: &mockVerifyBackupCodeUC{}, PluginConfig: &types.TwoFactorPluginConfig{}}

	req, reqCtx, w := newAuthenticatedRequest(t, "POST", "/two-factor/verify-backup-code", types.VerifyBackupCodeRequest{Code: "abc123"})
	h.Handler().ServeHTTP(w, req)
...
func TestVerifyBackupCodeHandler_InvalidCode(t *testing.T) {
	...
	h := &VerifyBackupCodeHandler{UseCase: uc, PluginConfig: &types.TwoFactorPluginConfig{}}

	req, reqCtx, w := newPendingCookieRequest(t, "/two-factor/verify-backup-code", types.VerifyBackupCodeRequest{Code: "wrong"}, "pending-abc")
	h.Handler().ServeHTTP(w, req)
...
func TestVerifyBackupCodeHandler_InvalidPendingToken(t *testing.T) {
	...
	req, reqCtx, w := newPendingCookieRequest(t, "/two-factor/verify-backup-code", types.VerifyBackupCodeRequest{Code: "abc123"}, "bad-token")
	h.Handler().ServeHTTP(w, req)
